...
var StickyContainer = /** @class */ (function (_super) {
    ...
    StickyContainer.prototype.renderCompat = function () {
        ...
        var recycler = React.cloneElement(this.props.children, __assign(__assign({}, this.props.children.props), { ref: this._getRecyclerRef, onVisibleIndicesChanged: this._onVisibleIndicesChanged, onScroll: this._onScroll, applyWindowCorrection: this._applyWindowCorrection }));
